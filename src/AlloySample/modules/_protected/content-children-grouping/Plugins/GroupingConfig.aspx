...
<asp:Content runat="server" ContentPlaceHolderID="HeaderContentRegion">
    ...
    <link href='<%= GetPath("static/css/main.d1f5a29e.chunk.css") %>'rel="stylesheet" />
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="MainRegion">
    ...
    <div class="epi-formArea">
        <div class="epi-size20">
           ...
           <script src='<%= GetPath("static/js/2.06688cc0.chunk.js") %>'></script>
            <script src='<%= GetPath("static/js/main.f9400bbc.chunk.js") %>'></script>
        </div>
    </div>
</asp:Content>